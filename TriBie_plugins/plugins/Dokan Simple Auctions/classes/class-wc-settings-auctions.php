	...
	public function get_settings() {
		...
		return apply_filters( 'woocommerce_' . $this->id . '_settings', array(
			...
			array(	'title' => __( 'Simple auction options', 'wc_simple_auctions' ), 'type' => 'title','desc' => '', 'id' => 'simple_auction_options' ),
										...
										array(
											'title' 			=> __( "Do not show auctions in products shortcodes", 'wc_simple_auctions' ),
											'desc' 				=> __( 'Do not mix auctions and regular products in product shortcodes', 'wc_simple_auctions' ),
											'type' 				=> 'checkbox',
										...
										array(
											'title' 			=> __( "Allow on proxy auction change to smaller max bid value", 'wc_simple_auctions' ),
											'type' 				=> 'checkbox',
