...
<div id="bookings_availability" class="panel woocommerce_options_panel">
	<div class="options_group">
		...
		<?php
		$more_info_link = ' <a href="https://docs.woocommerce.com/document/creating-a-bookable-product/#section-12">' . esc_html__( 'view our documentation here.', 'woocommerce-booking' ) . '</a>';
		woocommerce_wp_checkbox(
			array(
