        ...
        <div id="rm_otp_login">
            ...
            <div id="rm_otp_enter_otp" style="display:none" class="rm_otp_after_email rm-otpw-animationRight">
                ...
                <div class="dbfl rm_otpw_login_panel_fields rm_otpw_field_container ">
                    ...
                    <input type="text" value="" placeholder="<?php _e('OTP', 'custom-registration-form-builder-with-submission-manager'); ?>" maxlength="50" name="<?php echo wp_generate_password(5, false, false); ?>" id="rm_otp_kcontact" class="rm_otpw_input_box" onkeypress="return rm_otpw_proceed(event, this)"/>
            ...
            <div id="rm_otp_enter_password" style="display:none" class="rm_otp_after_email rm-otpw-animationRight">
                ...
                <div class="dbfl rm_otpw_login_panel_fields rm_otpw_field_container">
                    ...
                    <input type="password" value="" placeholder="<?php _e('Password', 'custom-registration-form-builder-with-submission-manager'); ?>" maxlength="50" name="<?php echo wp_generate_password(5, false, false); ?>" id="rm_otp_kcontact" class="rm_otpw_input_box" onkeypress="return rm_otpw_proceed(event, this)"/>
