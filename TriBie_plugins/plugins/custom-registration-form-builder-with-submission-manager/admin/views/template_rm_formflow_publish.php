...
<script type="text/javascript" src="<?php echo RM_BASE_URL . 'admin/js/'; ?>script_rm_formflow.js"></script>
    ...
    <div  class="rm-grid rm-dbfl">
        ...
        <div class="rm-grid-section rm-dbfl rm_publish_section" id="rm_publish_shortcode"> 
            ...
            <div class="rm-publish-text"><?php _e('The most common method. Copy this shortcode and paste it inside a page or post where you want to display the form.','custom-registration-form-builder-with-submission-manager'); ?></div>
