 ...
 <div class="rm_pr_row">
            ...
            <div class="rm_pr_block_left">
                ...
                <div class="rm_pr_row rm_pitch_action_button">
                    <a href="https://registrationmagic.com/comparison/" target="_blank"><button class="rm_pr_action"><?php _e("Get Premium",'custom-registration-form-builder-with-submission-manager') ?> </button></a>
                </div>
                <div class="rm_pr_row rm_pitch_action_button">
