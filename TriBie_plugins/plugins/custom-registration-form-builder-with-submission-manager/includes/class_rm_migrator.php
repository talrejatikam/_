...
//echo "<pre>", var_dump($res), "</pre>";
    ...
    public function migrate_forms()
    {
        ...
        $dbcolumns = array('form_id', 'form_name', 'form_type', 'form_user_role', 'default_user_role', 'form_should_send_email', 'form_redirect', 'form_redirect_to_page', 'form_redirect_to_url', 'form_should_auto_expire', 'form_options');
...
//Central utility
    private function insert_array($identifier, $table_name, $array_data)
    {
        global $wpdb;
        $data_mapping = $this->value_map[$identifier];
        $cols = '';
...
//Mappers.
    private function get_options_mapping()
    {
    ...
    private function get_pp_fields_mapping()
    {
    ...
    private function get_pp_logs_mapping()
    {
        $a = array('id' => 'id',
    ...
    private function get_stats_mapping()
    {
        $a = array('id' => 'stat_id',
            'form_id' => 'form_id',
            'stats_key' => null,
    ...
    private function get_forms_mapping()
    {
        return array(
            'id' => 'form_id',
            'form_name' => 'form_name',
    ...
    private function get_notes_mapping()
    {
        return array(
            'id' => 'note_id',
    ...
    private function get_front_users_mapping()
    {
    ...
    private function get_fields_mapping()
    {
    ...
    private function get_field_type_migrated()
    {
        return array(
            'heading' => 'HTMLH',
            'paragraph' => 'HTMLP',
    ...
    private function get_submissions_mapping()
    {
...
//Miscs.
    private function crf_encrypt_decrypt_pass($action, $string)
    {
        $output = false;
...
// iv - encrypt method AES-256-CBC expects 16 bytes - else you will get a warning
    ...
    private function enc_str($string)
    {
...
//Add column if not present.
    ...
    private function crf_entries_act_ins($dst_data)
    {
        global $wpdb;
        $wpfx = $wpdb->prefix;
    ...
    private function crf_assign_key_for_previous_field()
    {
        global $wpdb;
        $crf_fields = $wpdb->prefix . "crf_fields";
    ...
    private function crf_get_field_key($row)
    {
