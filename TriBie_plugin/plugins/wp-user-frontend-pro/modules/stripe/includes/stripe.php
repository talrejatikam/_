...
class WPUF_Gateway_Stripe {
    ...
    public function configure_stripe_webhook() {
        ...
        //$listener_url = 'http://5fbf0400.ngrok.io//?action=wpuf_stripe_payment_response';
    ...
    public function process_payment() {
        ...
        if ( wpuf_get_option( 'use_legacy_stripe_api', 'wpuf_payment', 'off' ) == 'on' ) {
            $old_api = true;
